...
<body>
<form id="form2" action="/auth/role/save.do" method="post">
...
<div >
	...
	<table>
		<tr>
			<td>角色名称</td>
			<td><input id="roleName" name="roleName" type="text"  value="${bean.roleName }" ltype="text"  validate="{required:true,minlength:3,maxlength:10}"/></td>
			 <td align="left"></td>
		</tr>
