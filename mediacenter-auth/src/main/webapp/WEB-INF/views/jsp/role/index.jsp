...
<title>Insert title here</title>
  <link href="/auth/js/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
   ...
   <link href="/auth/js/ligerUI/skins/ligerui-icons.css" rel="stylesheet" type="text/css" />
        ...
        function add()
        {
        	$.ligerDialog.open({  url: '<%=ctxPath%>/role/init_add.do', height: 300,width: 500, 
        		id: "editDailog",
        		name: "editFrame",
        		title: '编辑',     
        		buttons: [ 
        ...
        function update()
        {
        	...
        	$.ligerDialog.open({  url: '/auth/role/init_update.do?id='+ids, height: 300,width: 500, 
        		id: "editDailog",
        		name: "editFrame",
        		title: '编辑',     
        		buttons: [ 
        ...
        {
        	  var gridparms = [];
              gridparms.push({ name: "roleName", value: $("#roleName").val() });
...
<div id="searchbar">
		<table>
			<tr>
				<td> 角色名：<input id="roleName" type="text" /></td>
