   ...
   <link href="/auth/js/ligerUI/skins/ligerui-icons.css" rel="stylesheet" type="text/css" />
        ...
        $(function () {
            grid = $("#maingrid4").ligerGrid({
                ...
                { display: '用户组名', name: 'userGroupName' },
                { display: '创建时间', name: 'createTime' }
                ], 
                params : [],
                url: "/auth/usergroup/list.do", 
                toolbar: { 
                	items: [
        ...
        function add()
        {
        	$.ligerDialog.open({  url: '/auth/usergroup/init_add.do', height: 300,width: 500, 
        		id: "editDailog",
        		name: "editFrame",
        		title: '编辑',     
        		buttons: [ 
        ...
        function update()
        {
        	...
        	$.ligerDialog.open({  url: '/auth/usergroup/init_update.do?id='+ids, height: 300,width: 500, 
        		id: "editDailog",
        		name: "editFrame",
        		title: '编辑',     
        		buttons: [ 
        ...
        {
        	  var gridparms = [];
              gridparms.push({ name: "userGroupName", value: $("#userGroupName").val() });
...
<div id="searchbar">
		<table>
			<tr>
				<td> 用户组名：<input id="userGroupName" type="text" /></td>
